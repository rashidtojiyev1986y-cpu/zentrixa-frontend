...
<head>
    ...
    <meta name="description"
        content="ZENTRIXA - AI-powered English vocabulary learning platform. O'zbekcha-inglizcha lug'at, 15 ta test savollari, A1 dan C1 dagacha 5 ta darajalar. Bepul o'rganing">
    <meta name="keywords"
        content="english vocabulary, английский язык, узбекский, learn english, lug'at, test, A1, A2, B1, B2, C1, ZENTRIXA">
...
<body>
    ...
    <section id="auth" class="auth-section">
        ...
        <div class="auth-container">
            ...
            <div id="loginForm">
                ...
                <p>Akkaunt yo'qmi?
                    <span onclick="showRegister()">Ro'yxatdan o'ting</span>
                </p>
            </div>

            <div id="registerForm" style="display:none;">
                <h2>Register</h2>
                <input type="text" id="registerName" placeholder="F.I.O">
                <input type="email" id="registerEmail" placeholder="Email">
                <input type="password" id="registerPassword" placeholder="Parol">
                <button onclick="register()">Akkaunt yaratish</button>
                <p>Akkaunt bormi?
                    <span onclick="showLogin()">Kirish</span>
                </p>
            </div>
    ...
    <script>
        ...
        const QUIZ_QUESTIONS = {
            A1: [
                { question: "O'zbek tiliga 'hello' qanday aytiladi?", options: ["salom", "ona", "kitob", "suv"], answer: "salom" },
                { question: "'book' nima?", options: ["suv", "kitob", "uy", "kun"], answer: "kitob" },
                { question: "Muasir joyni anglatgan so'z?", options: ["kun", "uy", "yo'l", "shahar"], answer: "uy" },
                { question: "'maktab' qanday tarjima?", options: ["house", "school", "work", "phone"], answer: "school" },
                { question: "'water' o'zbekchada?", options: ["ovqat", "suv", "ota", "do'st"], answer: "suv" },
                { question: "'ovqat' nima?", options: ["drink", "water", "food", "mother"], answer: "food" },
                { question: "'ona' kim?", options: ["father", "mother", "friend", "child"], answer: "mother" },
                { question: "'do'st' qanday?", options: ["work", "friend", "day", "night"], answer: "friend" },
                { question: "'ish' qanday to'g'ri tarjima?", options: ["day", "work", "year", "person"], answer: "work" },
                { question: "'bola' nima?", options: ["woman", "child", "man", "person"], answer: "child" },
                { question: "'stol' nima?", options: ["chair", "table", "window", "door"], answer: "table" },
                { question: "'stul' nima?", options: ["table", "chair", "clock", "window"], answer: "chair" },
                { question: "'telefon' qanday?", options: ["road", "phone", "door", "window"], answer: "phone" },
                { question: "'yo'l' nimani anglatadi?", options: ["house", "road", "school", "city"], answer: "road" },
                { question: "'ken' o'zbekcha qanday?", options: ["night", "year", "day", "morning"], answer: "day" }
            ],
            A2: [
        ...
        function startQuiz(level) {
            ...
            document.getElementById("quizResults").style.display = "none";
            document.getElementById("quizLevelTitle").innerText = `Test - ${level} Darajasi`;
        ...
        <div class="leaderboard">
            ...
            <div class="leaderboard-item">
                <span class="leaderboard-rank">1. Ali Muhammad</span>
                <span>5/5</span>
            </div>
            <div class="leaderboard-item">
                <span class="leaderboard-rank">2. Shukhrat Isomov</span>
                <span>4/5</span>
            </div>
            <div class="leaderboard-item">
